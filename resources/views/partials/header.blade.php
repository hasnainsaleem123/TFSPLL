                ...
                <div class="hidden md:flex">
                    <nav>
                        <ul
                            ...
                            <li class="relative group cursor-pointer hover:text-gray-300"><a href="/ranking">Awards</a>
                            </li>
                            <li class="relative group cursor-pointer hover:text-gray-300"><a href="/news">Players</a>
                            </li>
                        </ul>
                    </nav>
                </div>
