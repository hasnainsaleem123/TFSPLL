    ...
    <div
        ...
        <div class="flex flex-col justify-between lg:flex-row xl:mt-0 lg:mt-3 lg:gap-0 min-[365px]:gap-3">
            ...
            <div class="flex justify-center lg:justify-end 2xl:gap-[44px] xl:gap-[20px] lg=:gap-3 min-[365px]:gap-4 ">
                <button
                    class="2xl:px-6 2xl:py-[11px] xl:px-4 xl:py-[6px] lg:px-3 lg:py-[2px] min-[365px]:px-4 min-[365px]:py-[9px] bg-[#094AB7] text-white  2xl:text-[14px] xl:text-[11px] lg:text-[9px] min-[365px]:text-[12px] font-montserrat font-normal rounded-[5px] ">❮
                    Previous Post</button>
                <button
                    class="2xl:px-6 2xl:py-[11px] xl:px-4 xl:py-[6px] lg:px-3 lg:py-[2px] min-[365px]:px-4 min-[365px]:py-[9px] bg-[#094AB7] text-white  2xl:text-[14px] xl:text-[11px] lg:text-[9px] min-[365px]:text-[12px] font-montserrat font-normal rounded-[5px]">Next
                    Post ❯</button>
            </div>
        </div>
